                        ...
                        <div class="estimated_input_loop">
                            ...
                            <div class="estimated_input_section estimated_input_with_pin">
                                ...
                                <div class="estimated_input_wrapper">
                                    ...
                                    <input type="text" placeholder="straatnaam met huisnummer">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="estimated_input_radio_section">
                            <div class="estimated_input_radio_wrapper estimated_input_click">
                                <label>
                                    ...
                                    <input type="radio" name="luggage" checked>
                                    Ja
                                </label>
                            </div>
                    ...
                    <div class="estimated_body_right">
                        ...
                        <div class="estimated_input_section">
                            <div class="estimated_input_wrapper">
                                ...
                                <input type="text" placeholder="Selecteer datum en tijd">
                            </div>
                        </div>
                        ...
                        <div class="estimated_input_radio_wrapper estimated_input_radio_wrapper_topgap estimated_check_circle_click">
                            ...
                            <input type="checkbox" name="" id="retour_confirm">
                        </div>
                        ...
                        <div class="estimated_input_section estimated_input_disabled_check estimated_input_disabled">
                            <div class="estimated_input_wrapper">
                                ...
                                <input type="text" placeholder="Enkele reis">
                            </div>
                        </div>
                    </div>
                </div>
