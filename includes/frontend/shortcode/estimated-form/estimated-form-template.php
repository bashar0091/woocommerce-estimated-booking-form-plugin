                ...
                <form action="" method="post">
                    ...
                    <div class="estimated_body_section">
                        <div class="estimated_body_left">
                            ...
                            <p class="title_3 title_3_gap">Reis je met bagage?</p>

                            <div class="estimated_input_radio_section">
                                <div class="estimated_input_radio_wrapper estimated_input_click">
                                    <label>
                                        <span class="estimated_radio_circle active"></span>
                                        <input type="radio" name="luggage_condition" value="luggage_yes" checked>
                                        Ja
                                    </label>
                                </div>
                                ...
                                <div class="estimated_input_radio_wrapper estimated_input_click">
                                    <label>
                                        <span class="estimated_radio_circle"></span>
                                        <input type="radio" name="luggage_condition" value="luggage_no">
                                        Nee, ik heb geen bagage
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="estimated_body_right">
                                ...
                                <div class="estimated_input_wrapper">
                                    <span class="estimated_input_icon">
                                        <svg width="100%" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M7.75 2.5C7.75 2.08579 7.41421 1.75 7 1.75C6.58579 1.75 6.25 2.08579 6.25 2.5V4.07926C4.81067 4.19451 3.86577 4.47737 3.17157 5.17157C2.47737 5.86577 2.19451 6.81067 2.07926 8.25H21.9207C21.8055 6.81067 21.5226 5.86577 20.8284 5.17157C20.1342 4.47737 19.1893 4.19451 17.75 4.07926V2.5C17.75 2.08579 17.4142 1.75 17 1.75C16.5858 1.75 16.25 2.08579 16.25 2.5V4.0129C15.5847 4 14.839 4 14 4H10C9.16097 4 8.41527 4 7.75 4.0129V2.5Z" fill="#5a238d"/>
                            ...
                            <div class="estimated_input_wrapper estimated_input_count">
                                ...
                                <input type="number" name="estimated_ride_person" value="0" class="person_count" min="0" max="8">
