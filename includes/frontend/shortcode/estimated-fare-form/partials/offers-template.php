...
<form method="post" action="">
    <div id="offers" class="step-tab show">
                    ...
                    <label>
                        <div class="car_list_fare_item ' . ($i == 1 ? "active" : '') . ' ">    
                            ...
                            <div class="car_fare_price_confirm">';
                                ...
                                if($_SESSION['price_range']) {
                                    $result .= '
                                        <input type="hidden" value="' . intval($_SESSION['price_range']) . '" class="car_price">
                                        <h4>€ '.intval($_SESSION['price_range']).'</h4>  
                                    ';
                                } else {
                                    $result .= '
                                ...
                                $result .= '<button style="pointer-events: none" class="fare_button_submit">Selecteer</button>
                            </div>
                        </div>
                    </label>';
                }
        ...
        <div class="fare_body_footer_section">
            <div>
                <a href="/boek" class="back_arrow back_arrow_first">
