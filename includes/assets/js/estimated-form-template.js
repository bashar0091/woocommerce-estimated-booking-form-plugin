            ...
            <div class="estimated_input_section estimated_input_with_pin">
                ...
                <div class="estimated_location_suggest">
                    <div class="estimated_input_wrapper">
                        ...
                        <input type="text" name="estimated_middile_point[${number_count}]" class="estimated_location_map estimated_addresss" placeholder="Tussenstop straatnaam met huisnummer" required>
                        <input type="text" name="estimated_middile_point_holding[${number_count}"] class="estimated_holding" placeholder="Holding No." required>
